...
/** 
 * DAO for table PeopleInfo.
*/
public class PeopleInfoDao extends AbstractDao<PeopleInfo, Long> {

    public static final String TABLENAME = "PeopleInfo";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PeopleInfo' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'PeopleInfo'";
        db.execSQL(sql);
    }
