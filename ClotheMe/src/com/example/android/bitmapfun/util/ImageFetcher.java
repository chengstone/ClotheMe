...
import com.example.clotheme.BuildConfig;
...
//            Log.d(TAG, "downloadBitmap - downloading - " + urlString);
        ...
        if(isCatch == true){
//        	try{
//        		FileInputStream fin = new FileInputStream(urlString);
//                final BufferedInputStream in =
//                        new BufferedInputStream(fin,Utils.IO_BUFFER_SIZE);
//                out = new BufferedOutputStream(new FileOutputStream(cacheFile), Utils.IO_BUFFER_SIZE);
//
//                int b;
//                while ((b = in.read()) != -1) {
...
//                file = creatSDFile(path + fileName); 
                ...
                FileInputStream input = new FileInputStream(urlString);
